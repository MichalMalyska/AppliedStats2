data {
  ...
  int<lower=1, upper=2> VR[N]; // VR indicator
...
generated quantities {
  ...
  for (n in 1:N) {
    ...
    log_lik[n] = normal_lpdf(y[n] | post_mu, sigma_y[VR[n]]);
    y_rep[n] = normal_rng(post_mu, sigma_y[VR[n]]);
  }
}
