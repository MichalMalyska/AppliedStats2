...
```{r}
years <- 2008:2016
base_url <- "https://www.cdc.gov/drugoverdose/maps/rxstate"
year_urls <- paste0(base_url, years, ".html")
...
for (i in 1:length(years)) {
  ...
  prescriptions_all_years <-
    bind_rows(prescriptions_all_years, d_prescriptions) # assuming your tibble is called d_prescriptions
